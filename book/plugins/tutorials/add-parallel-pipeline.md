...
The jobs to create them are distributed as indicated in the user's [QIIME 2 parallel configuration](https://use.qiime2.org/en/2026.4/references/parallel-configuration.html).
